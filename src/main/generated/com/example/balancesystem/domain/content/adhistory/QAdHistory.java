...
public class QAdHistory extends EntityPathBase<AdHistory> {
    ...
    private static final long serialVersionUID = -189236823L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QAdHistory adHistory = new QAdHistory("adHistory");

    public final com.example.balancesystem.domain.content.ad.QAd ad;
    ...
    public QAdHistory(Class<? extends AdHistory> type, PathMetadata metadata, PathInits inits) {
        ...
        this.ad = inits.isInitialized("ad") ? new com.example.balancesystem.domain.content.ad.QAd(forProperty("ad")) : null;
